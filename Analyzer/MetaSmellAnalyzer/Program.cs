...
namespace MetaSmellDetector
{
    ...
    public class Options
    {
        ...
        [Option('f', "file", Required = false, HelpText = "file.txt with the list of smells to search")]
        ...
        [Option('c', "category", Required = false, HelpText = "Save results by smell category")]
        public bool SaveOnMultipleFile { get; set; }
        [Option('p', "project", Required = false, HelpText = "Save results as csv file for the project")]
